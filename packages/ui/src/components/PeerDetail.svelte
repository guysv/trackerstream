<script lang="ts">
  ...
  import { peers, speedHistory, connectedSince, clearSelection } from "../peers.svelte";
  import { peerDetail, peerPlaylists, requestPlaylist, type PeerDetail, type PeerPlaylists } from "../p2p";
