<script lang="ts">
  ...
  import { searchStream, cancelSearch, warmCatalog, type ModuleHit } from "../catalog";
  import { plSearch, type PlaylistMeta } from "../playlists.svelte";
  import { playList } from "../player.svelte";
