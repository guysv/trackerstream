module github.com/trackerstream/tsnode
...
// go-libp2p v0.48.0 still embeds `core/` as part of the main module; a transitional
// separate `go-libp2p/core` module (only an rc tag exists) collides with it. Nothing we
